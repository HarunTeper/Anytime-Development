...
| ------------- | ------- | ------------- | ---------- | --------- |
| Figure 5a (total iterations) | `./scripts/reproduce_figure.sh 5a` | ~40 min | `--quick` ~5 min | A, B, C |
| Figure 5b (cancel-to-finish latency) | `./scripts/reproduce_figure.sh 5b` | ~40 min | `--quick` ~5 min | A, B, C |
