...
class AnytimeActionClient : public rclcpp::Node
{
    ...
    private:
        ...
        void cancel_response_callback(std::shared_ptr<action_msgs::srv::CancelGoal::Response>);
        ...
        std::shared_future<action_msgs::srv::CancelGoal_Response::SharedPtr> cancel_future_;
