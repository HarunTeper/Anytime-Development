"""Launch file for RRT* experiment with server and client components."""
...
def launch_setup(context, *args, **kwargs):
    ...
    container_name = context.launch_configurations.get(
        'container_name', 'rrt_star_experiment_container')
    ...
    default_client_config = os.path.join(
        experiments_dir, 'config', 'rrt_star', 'default_client.yaml')
    default_server_config = os.path.join(
        experiments_dir, 'config', 'rrt_star', 'default_server.yaml')
...
def generate_launch_description():
    ...
    container_name_arg = DeclareLaunchArgument(
        'container_name',
        default_value='rrt_star_experiment_container',
